...
def dessine(surface: tuple[int, int], scene):
    """
    Fonction qui dessine la scène

        Argument:
            - surface: la taille de la surface d'affichage
            - scene : Dictionnaire contenant les attributs de la scène (dont les nuages).
    """
    x = 100
    y = 550
    ...
    dessine_sol(surface)
    nuages.dessine(scene["nuages"], surface)
...
def nuages_dessine(surface, x, y):
    """
